...
<body style="margin:0;padding:0;font-family:\'Segoe UI\',Tahoma,Geneva,Verdana,sans-serif;background:#eeeae6;">
            ...
            <table width="700" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 8px 25px rgba(43,30,26,0.18);">
                ...
                <tr>
                    <td style="background:#2b1e1a;padding:28px 32px;">
                        <h1 style="margin:0;color:#c28a4d;font-size:22px;text-shadow:1px 1px 3px rgba(0,0,0,0.4);">🎉 747 Disco CRM</h1>
                        <p style="margin:6px 0 0;color:#eeeae6;font-size:14px;">Report ogni 3 giorni · ' . esc_html($week_label) . '</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:28px 32px;background:#fff;">
                        ...
                        <p style="margin:0 0 24px;font-size:14px;color:#555;">
                            Hai <strong>' . $count . '</strong> ' . ($count === 1 ? 'preventivo' : 'preventivi') . ' non ancora confermati negli ultimi 10 giorni.
                        ...
                        <p style="margin:24px 0 0;font-size:12px;color:#90858a;">
